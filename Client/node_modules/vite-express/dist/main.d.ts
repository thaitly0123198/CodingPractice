...
declare function bind(app: ExpressApp, server: http.Server | https.Server, callback?: () => void): Promise<void>;
declare function listen(app: ExpressApp, port: number, callback?: () => void): http.Server<typeof http.IncomingMessage, typeof http.ServerResponse>;
...
declare const _default: {
    ...
    build: typeof build;
    static: (options?: ExpressStaticGzipOptions) => express.RequestHandler<import("express-serve-static-core").ParamsDictionary, any, any, import("qs").ParsedQs, Record<string, any>>;
